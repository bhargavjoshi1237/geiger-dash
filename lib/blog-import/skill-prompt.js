...
- The content field must be a clean semantic HTML fragment: use <h2>, <h3>, <p>, <ul>, <ol>, <li>, <strong>, <em>, <blockquote>, <hr>. No <html>, <head>, <body>, no markdown, no code fences.`
...
export function buildBlogImportUserPrompt({ sourceText, categories = [] }) {
...
export function normalizeImportedPost(result, { categories = [] } = {}) {
