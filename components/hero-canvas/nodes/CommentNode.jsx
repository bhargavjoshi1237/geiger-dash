    ...
    <div className="relative group">
      ...
      >
        ...
        <div className="flex-1 relative flex items-center">
          <input
            type="text"
            className="w-full bg-[#3B4654] text-zinc-200 text-sm rounded px-3 py-2 pr-10 focus:outline-none focus:ring-1 focus:ring-zinc-500 placeholder:text-zinc-500 font-sans"
