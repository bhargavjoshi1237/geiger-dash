      ...
      {!isSessionActive ? (
        <div className="text-center space-y-5 animate-in fade-in -mt-10">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-foreground0 max-w-[260px] mx-auto">
          ...
          <div className="space-y-4">
            ...
            <div className="relative group">
              ...
              <button
                ...
                className="relative w-full flex items-center justify-center gap-3 bg-surface-subtle border border-border hover:border-border-strong/50 rounded-xl p-4 transition-all duration-300 group-hover:shadow-2xl group-hover:shadow-emerald-900/10"
              >
                ...
                <div className="flex items-center w-[10%] justify-center gap-1.5 text-xs text-foreground0 font-medium group-hover:text-emerald-500/80 transition-colors">
                  {copied ? (
                    <>
