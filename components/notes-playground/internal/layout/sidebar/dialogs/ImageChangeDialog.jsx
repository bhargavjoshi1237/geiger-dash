...
export default function ImageChangeDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px] bg-[#1e1e1e] border-border text-foreground">
        <DialogHeader>
        ...
        <div className="grid gap-5 py-4">
          ...
          <div
            className="border-2 border-dashed border-border-strong rounded-lg p-6 flex flex-col items-center justify-center min-h-[200px] cursor-pointer hover:border-zinc-500 transition-colors bg-surface-subtle/50"
          ...
          {previewUrl && (
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <Label className="text-muted-foreground">Compression Quality</Label>
