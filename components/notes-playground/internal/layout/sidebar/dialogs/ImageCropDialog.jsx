    ...
    <div className="fixed inset-0 z-[99999] bg-black/95 flex flex-col items-center justify-center cursor-default animate-in fade-in duration-200 select-none">
      <div className="absolute top-5 right-5 flex items-center gap-2 z-50 pointer-events-auto">
        ...
        <Button
          ...
          size="icon"
          onClick={handleSave}
          className="rounded-full w-10 h-10 bg-surface-strong hover:bg-zinc-600 text-white transition-colors"
          title="Apply Crop"
        >
          <Check size={18} />
        </Button>
      ...
      {imgLoaded && (
        <div className="mt-4 text-foreground0 text-xs bg-surface-subtle/80 px-3 py-1.5 rounded-lg border border-border">
