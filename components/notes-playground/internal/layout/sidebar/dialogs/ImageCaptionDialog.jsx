...
import ColorPicker from "@/components/notes-playground/internal/edges/ColorePicker";
...
const ImageCaptionDialog = ({ open, onOpenChange, initialData, onSave }) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px] bg-[#1e1e1e] border-border text-foreground">
        <DialogHeader>
        ...
        <div className="grid gap-4 py-4">
          <div className="grid gap-2">
            ...
            <Input
              ...
              className="bg-surface-hover border-border-strong text-foreground focus:ring-zinc-600 focus:border-zinc-600"
