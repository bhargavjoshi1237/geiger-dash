    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px] bg-[#1e1e1e] border-border text-foreground">
        ...
        <div className="grid gap-5 py-4">
          ...
          <div
            className="border-2 border-dashed border-border-strong rounded-lg p-6 flex flex-col items-center justify-center min-h-[150px] cursor-pointer hover:border-zinc-500 transition-colors bg-surface-subtle/50"
