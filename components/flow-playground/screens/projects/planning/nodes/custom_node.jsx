...
function CustomNode({ data, selected, id }) {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "bg-[#1e1e1e] border border-border rounded-lg shadow-md min-w-[180px] min-h-[40px] transition-colors duration-200 overflow-hidden",
      ...
      >
        <div className="px-4 py-3">
          <div
            className={cn(
              "text-foreground text-sm leading-relaxed whitespace-pre-wrap break-words",
