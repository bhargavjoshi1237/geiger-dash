        ...
        <div className="space-y-4">
          <div className="rounded-xl border border-[#2a2a2a] bg-[#1a1a1a] p-4">
            <div className="flex items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-1.5 rounded-full border border-[#333333] px-2 py-1 text-[11px] text-[#a3a3a3]">
          ...
          {requiresPurpose && !isUnlocked && (
            <div className="space-y-2">
              ...
              <Textarea
                ...
                className="min-h-[72px] resize-none bg-[#1a1a1a] border-[#2a2a2a] text-[#ededed] placeholder:text-[#525252] focus:border-[#3a3a3a]"
              />
            </div>
          )}
          ...
          {!isUnlocked ? (
            <div className="space-y-4">
              ...
              <div className="rounded-xl border border-[#2a2a2a] bg-[#1a1a1a] p-4">
                <div className="mb-3 flex items-center gap-2 text-sm font-medium text-white">
                  <ActiveIcon className="size-4 text-[#a3a3a3]" />
                  {METHOD_COPY[activeMethod]?.label}
                </div>
                <p className="mb-3 text-xs leading-5 text-[#737373]">
            ...
            <div className="space-y-3 rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-4">
              ...
              <div className="relative flex items-center rounded-lg border border-[#2a2a2a] bg-[#111111] py-2.5 pl-3 pr-20">
                <code className="block min-w-0 flex-1 truncate font-mono text-xs text-[#ededed]">
                  {showSecret ? secretValue || "No secret saved" : "************************"}
                </code>
                <button
                  type="button"
                  onClick={() => setShowSecret((current) => !current)}
                  className="absolute right-11 top-1/2 flex size-7 -translate-y-1/2 items-center justify-center rounded-md text-[#737373] transition-colors hover:bg-[#202020] hover:text-white"
                ...
                <button
                  ...
                  className="absolute right-2 top-1/2 flex size-7 -translate-y-1/2 items-center justify-center rounded-md text-[#d4d4d4] transition-colors hover:bg-[#202020] hover:text-white disabled:cursor-not-allowed disabled:opacity-50"
